    ...
    <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
        <div
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                <!-- Notifications menu -->
                <li class="relative">
                    <button @click="onclickShowNotification" class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-purple"
                    ...
                    <template :class="{ 'block': shownotification }">
                ...
                <button
                    ...
                    <template :class="{ 'block': showProfileMenu }">
                        ...
                        aria-label="submenu">
                        <li class="flex">
                            <router-link @click="onclickProfile" to="/backend/profile"
    ...
    methods:{
        ...
        onclickLogout(){
            ...
            http.post('logout').then(() => {
                ...
                localStorage.removeItem('user') // line 120 in view/frontend/login
                // กลับไปหน้า login
