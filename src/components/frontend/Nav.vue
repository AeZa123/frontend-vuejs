        ...
        <nav class="container flex flex-wrap items-center px-4 mx-auto">
            ...
            <div class="hidden w-full ml-auto lg:block lg:w-auto">
                ...
                <div class="inline-block px-4 py-2">
                    <router-link to="" class="inline-block px-6 py-2 text-white bg-indigo-600 border-2 border-indigo-600 rounded-md hover:text-indigo-600 hover:bg-indigo-100">เข้าสู่ระบบ</router-link>
                </div>
            </div>
        </nav>
